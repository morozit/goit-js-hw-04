// ! this це не метод, це як аргумент - локальна зміна, змінна яка є тільки в середині функції
...
/*
  ? Контекст (this)
  ?    - Где и как была объявлен Я на контекст.
...
*/
// ! ==>>   this буде посилатися на обєкт якщо він викликається в методі обєкта
// const user = {
//     tag: 'Mango',
//     showTag() {
...
// user.showTag();
// showTag -> this {tag: "Mango", showTag: ƒ}
...
//!     При передаче метода обьекта как колбека контекст не сохраняется. Автоматической привязки контекста в js нет
